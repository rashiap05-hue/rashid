...
async def generate_proposal_pdf(proposal_id: str):
    ...
    class ProposalPDF(FPDF):
        ...
        def header(self):
            # Brand bar
            self.set_fill_color(0, 43, 91)  # #002B5B
...
async def search_flight(flight_number: str, date: Optional[str] = None):
    ...
    try:
        ...
        async with httpx.AsyncClient(timeout=30.0) as client:
            ...
            if response.status_code == 200:
                ...
                for flight in flights[:5]:  # Limit to 5 results
                    ...
                    # Safely get nested values with None checks
                    ...
                    # Extract time portion from scheduled datetime
                    dep_time_str = ""
                    if dep_scheduled:
                        # Format: "2024-01-15T14:30:00+00:00" - extract time
        ...
        return {"success": False, "error": "Flight API timeout", "flights": []}
    except Exception as e:
