...
- **Detail View Modals (March 2026)**: VIEW buttons on transfers and activities in ProposalView now open a detail modal showing full information — title, vehicle type, price, route (from/to), description, highlights, inclusions, start times, and photos.
