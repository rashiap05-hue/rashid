              ...
              <main className="max-w-7xl mx-auto px-6 py-8">
                {activeTab === 'Home' ? (
                  ...
                  <section className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                      ...
                      <div className="flex items-end">
                        <button className="w-full bg-[#002B5B] text-white py-2.5 rounded-lg font-bold hover:bg-[#003d82] transition-all shadow-lg shadow-[#002B5B]/20">
                          SEARCH
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    {[
                      { title: 'Book FIT Package', icon: Users, color: 'bg-blue-50 text-blue-600', onClick: onNewProposal || (() => setShowFitForm(true)) },
