...
function HotelSelectionModal({ isOpen, onClose, city, checkIn, checkOut, nights, onSelect, searchQuery = '', initialHotel = null, totalGuests = 2, adults = 1, children = 0, bookingRooms = [], roomConfig = [], onRoomsChange, maxPax = 0 }) {
